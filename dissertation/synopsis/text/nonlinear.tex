...
рассматривалась функция вида \( \psi = \theta_0 + \theta_1 \xi + \theta_2 \xi^2 \).
}

На рисунке~\ref{fig:comparison_nonlinear_quadratic_a-0_b-0_c-1}
представлен график функции \( d(\sigma_{\varepsilon_x}, \sigma_{\varepsilon_y}) \)
для параболической функции регрессии при \( \theta_0 = 0, \theta_1 = 0, \theta_2 = 1 \).
{\color{red}
...
На рисунке~\ref{fig:comparison_nonlinear_quadratic_a-0_b-0}
представлены графики функции \( d(\sigma_{\varepsilon_x}, \sigma_{\varepsilon_y}) \)
при \( \theta_0 = 0, \theta_1 = 0 \).
{\color{red}
В обоих случаях МРТ-оценки оказались более точными.
}
...
На рисунке~\ref{fig:comparison_nonlinear_quadratic_a-0_c-1}
представлены графики функции \( d(\sigma_{\varepsilon_x}, \sigma_{\varepsilon_y}) \)
при \( \theta_0 = 0, \theta_2 = 1 \).
{\color{red}
В первом случае (рисунок~\ref{fig:comparison_nonlinear_quadratic_a-0_b--5_c-1})
МРТ-оценки оказались более точными, чем НМНК, а во втором
(рисунок~\ref{fig:comparison_nonlinear_quadratic_a-0_b-5_c-1}) --- наоборот.

...
в значительно меньшей степени, чем идентификация линейных систем.
Это вызвано большим видовым разнообразием нелинейных систем,
а также сложностью построения и анализа методов их идентификации.

Для решения данной задачи предлагается использовать методы,
...
использования МНК и МРТ при идентификации нелинейных
...
На рисунке~\ref{lst:nonlinear_api_lse} представлен пример использования
...
\begin{enumerate}
\item Предложено использовать нелинейный метод наименьших квадратов
  и метод рядов Тейлора для идентификации нелинейных стохастических систем.
\item Разработаны программные реализации нелинейного метода
  наименьших квадратов и метода рядов Тейлора.
\item С использованием программных реализаций выполнен численный
  анализ точности оценивания параметров нелинейных стохастических систем
  второго типа.
\item На основании результатов анализа описаны условия
  предпочтительного использования НМНК и МРТ для

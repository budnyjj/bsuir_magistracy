...
\end{equation}
где \( x_j, y_j \) --- наблюдения входа и выхода системы,
называемые в данной работе опорными.
...
\item Разработаны программные реализации указанных методов.
\item С использованием программных реализаций выполнен численный
  ...
  второго типа с помощью МНК и МРТ.
